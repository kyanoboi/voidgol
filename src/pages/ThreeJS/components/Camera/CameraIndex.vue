<template>
  <div ref="containerRef" class="camera-container"></div>
</template>
...
const render = () => {
  ...
  const childMesh = mesh.children[0] as THREE.Mesh
  childMesh.position.x = 70 * Math.cos(2 * r)
  childMesh.position.z = 70 * Math.sin(r)
